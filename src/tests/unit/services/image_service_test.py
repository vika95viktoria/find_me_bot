...
class ImageServiceTestCase(TestCase):
    ...
    def setUp(self) -> None:
        self.face_model_patcher = patch('services.image_service.FaceAnalysis')
    ...
    def test_get_face_embedding(self):
        ...
        self.mock_face_model().get.assert_called_with(image)
    ...
    def test_get_face_embedding_from_bytes(self, mock_cv2, mock_np):
        ...
        self.mock_face_model().get.assert_called_with(img_arr)
